...
# include "headers/ICSVM/kernel.h"           /* this contains a user supplied kernel */

// long   verbosity=0;              /* verbosity level (0-4) */
                    ...
                    long int *totwords, long int *totdoc)
{
    char *line,*comment;
    WORD *words;
    long dnum=0,wpos,dpos=0,dneg=0,dunlab=0,queryid=0,slackid=0,max_docs=0;
