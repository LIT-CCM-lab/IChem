...
void IChemSwitch::helpIFP() const {
    cout
        ...
        << "\n"
        << "Fused ring stacking (one ligand ring system vs one residue ring system):\n"
        << "  -mergeStack closest  Keep only the shortest ring-ring stacking\n"
        << "  -mergeStack center   Face/Face: one stacking between the planes of all\n"
        << "                       stacking rings of each system (Edge/Face: closest)\n"
        << "               Default: every ring-ring stacking is reported\n"
        << "\n"
        << "Aromaticity (global option):\n"
        << "  --oldAro     Legacy ring perception (ring double/aromatic bond count)\n"
        << "               Default: aromatic if all ring atoms sp2 AND ring planar\n"
        << "\n"
